              ...
              <div role="article" aria-label="An email from Your Brand Name" lang="en" style="background-color: white; color: #2b2b2b; font-family: \'Avenir Next\', -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
                 ...
                 <header>
                     <a href="http://leodistrict306a2.org">
                         <center><img src="http://leodistrict306a2.org/assets/img/logos/A2_Logo_2020_21.png" alt="" height="200" width="200"></center>
                     </a>
                 ...
                 <footer>
                     <center><img style="width:150px; margin-top: 20px; position: relative; top: 10px;" src="http://leodistrict306a2.org/assets/img/common/footer/all_logos_bar.png"></center>
                     <h3 align="center" style="margin: 0;">Leo District 306 A2. Sri Lanka.</h3>
                     <center><a style="position: relative; top: -5px;font-size: 16px;text-decoration: none; color: gray;" href="http://leodistrict306a2.org/">www.leodistrict306a2.org</a></center>
